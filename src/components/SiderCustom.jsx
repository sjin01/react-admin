        ...
        return (
            ...
            >
                ...
                >
                    ...
                    <SubMenu
                        key="/app/test"
                        title={<span><Icon type="edit" /><span className="nav-text">测试</span></span>}
                    >
                        <Menu.Item key="/app/test/myTest"><Link to={'/app/test/myTest'}>第一个页面</Link></Menu.Item>
                    </SubMenu>
                </Menu>
                <style>
                    {`
